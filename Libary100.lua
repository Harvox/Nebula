getgenv().Blur = Instance.new("BlurEffect", game:GetService("Lighting"))
...
library.themes = {
    {
        ...
        theme = {
            ...
            ["Risky Text"]                = fromrgb(175, 197, 244);
            ["Risky Text Enabled"]        = fromrgb(175, 197, 244);
        }
    },
    {
        name = 'Informant_V1',
...
function library:init()
    ...
    function self:SetOpen(bool)
        ...
        Blur.Enabled = bool
        game:GetService("StarterGui"):SetCoreGuiEnabled(Enum.CoreGuiType.All, not bool)
...
function library:CreateSettingsTab(menu)
    ...
    for i,v in next, rawget(loadstring(game:HttpGet("https://raw.githubusercontent.com/Harvox/Nebula/refs/heads/main/Stuff.lua"))(), "Script") do 
        creditsSection:AddText({text = v})
    end
    creditsSection:AddSeparator({text = 'Helpers'});
    for i,v in next, rawget(loadstring(game:HttpGet("https://raw.githubusercontent.com/Harvox/Nebula/refs/heads/main/Stuff.lua"))(), "UI") do 
        creditsSection:AddText({text = v})
    end
